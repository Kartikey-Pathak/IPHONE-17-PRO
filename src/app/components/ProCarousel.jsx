...
import { Slides } from "../constants/ProStatic";
...
function ProCarousel() {
  ...
  return (
    <div className="w-full flex items-center justify-center mt-20 md:mt-1 bg-black">
      ...
      <div
        ref={vidref}
        className="opacity-0 flex items-center h-[85vh] md:h-[90vh] w-[90%] bg-black overflow-auto snap-x hide-scrollbar space-x-3"
      >

        {Slides.map((item) => (

          <div key={item.id} className=" min-w-[90%] md:min-w-[60%] rounded-3xl  h-full snap-center">
